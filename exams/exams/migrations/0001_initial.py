    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('only_guest_keys', models.BooleanField(default=True, help_text='При условии, что пользователю отображается результат', verbose_name='Доступ для гостей к результатам только по ссылке-приглашению')),
                ...
                ('priority', models.PositiveIntegerField(blank=True, help_text='Влияет на порядок выдачи теста, если он относится к спринту', null=True, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(99)], verbose_name='Приоритет')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, max_length=600, null=True, verbose_name='Краткое описание')),
