...
**[Live Demo](https://exams.usolcev.com/)** — демо для оценки функционала прохождения тестов. Регистрация займет меньше минуты, реальный email адрес указывать не обязательно. Демо-версия возвращается в исходное состояние в 03:00 ночи по московскому времени.
...
- индивидуальные настройки сервиса в админ-панели;
